...
class StackChecker:
    def __init__(self, model_path, camera_index=1, imgsz=640, conf_thres=0.5):
        # CONFIG
    ...
    def check(self):
        with self.lock:
            ...
            r = self.model.predict(frame, conf=self.CONF_THRES, imgsz=self.IMGSZ, verbose=False)[0]
            annotated = r.plot()
    ...
    def start(self, variante):
        self.set_variant(variante)
